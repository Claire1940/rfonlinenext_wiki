...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - RF Online Next Wiki',
    description: 'Copyright and intellectual property information for RF Online Next Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - RF Online Next Wiki',
      description: 'Copyright and intellectual property information for RF Online Next Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 RF Online Next Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of RF Online Next Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              RF Online Next Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Netmarble</strong> - Developer and publisher of RF Online Next</li>
              <li><strong>Epic Games</strong> - Distributor of the PC version</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>RF ONLINE NEXT</strong> - Trademark of Netmarble</li>
              <li><strong>Epic Games</strong> - Trademark of Epic Games, Inc.</li>
              <li><strong>RF Online Next Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with RF Online Next Wiki.
            </p>
            ...
            <p>
              ...
              RF Online Next Wiki<br />
              Email: <a href="mailto:dmca@rfonlinenext.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@rfonlinenext.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "RF Online Next Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: RF Online Next Wiki (rfonlinenext.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@rfonlinenext.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@rfonlinenext.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@rfonlinenext.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@rfonlinenext.wiki</a>
            </p>
            <p>
