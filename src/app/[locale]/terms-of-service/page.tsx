...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - RF Online Next Wiki",
    description: "Read the Terms of Service for RF Online Next Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our PC and mobile game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - RF Online Next Wiki",
      description: "Terms and conditions for using RF Online Next Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using RF Online Next Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using RF Online Next Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and RF Online Next Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              RF Online Next Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to RF Online Next. Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> RF Online Next Wiki is NOT affiliated with, endorsed by, or associated with
              Netmarble or the official developers of RF Online Next. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by RF Online Next Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Netmarble and/or the developers of RF Online Next. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Game availability and updates may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, RF ONLINE NEXT WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Epic Games, Discord, social media platforms,
            ...
            <p>
              ...
              you and RF Online Next Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@rfonlinenext.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@rfonlinenext.wiki</a>
            </p>
            <p>
