...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - RF Online Next Wiki',
    description: 'RF Online Next Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our PC and mobile game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              RF Online Next Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Epic Games, Discord, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              RF Online Next Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Netmarble or the developers of RF Online Next. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@rfonlinenext.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@rfonlinenext.wiki</a>
            </p>
            <p>
